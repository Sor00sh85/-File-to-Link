...
### Installation
#### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Sor00sh85/-File-to-Link)</br>


#### Deploy in your VPS
```
git clone https://github.com/Sor00sh85/-File-to-Link
cd File-Sharing-Bot
